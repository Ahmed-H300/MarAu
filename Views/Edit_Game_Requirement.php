...
<?php  include ('nav.php') ?>
  ...
  <!-- <nav class="navbar navbar-expand-lg navbar-light ">
    <div class="offset-sm-1 container-fluid">
      ...
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        <li class="nav-item">
          <a class="nav-link active nav-name text-white" aria-current="page" href="#1">MarAu | Edit Game Requirement</a>
        </li>
      </ul>
    </div>
  </nav> -->
  ...
  <div class="container">
    ...
    <div class="row align-items-left container-form" id="formBox">
      <div class="col-lg-12">
          <form id="formBox" method="POST" action="../Controller/editGameRequirement.php" enctype="multipart/form-data">
            <div id="1">

              <h1>Edit Game Requirement</h1>

              <input type="hidden" id="gameId"  name="gameId" value="<?= $gameId ?>"></input>

              <div class="mb-3">
                <input class="form-control" value="<?= $game->OperatingSystem ?>" id="OperatingSystem" name="OperatingSystem" placeholder="Operating System"></input>
                <p class="hide text-danger" id='OperatingSystemError'>This field is required</p>
              </div>
              
              <div class="mb-3">
                <input class="form-control" value="<?= $game->MinimumCPU ?>" id="MinimumCPU" name="MinimumCPU" placeholder="Minimum CPU"></input>
                <p class="hide text-danger" id='MinimumCPUError'>This field is required</p>
              </div>

              <div class="mb-3">
                <input class="form-control" value="<?= $game->RecommendedCPU ?>" id="RecommendedCPU" name="RecommendedCPU" placeholder="Recommended CPU"></input>
                <p class="hide text-danger" id='RecommendedCPUError'>This field is required</p>
              </div>   

              <div class="mb-3">
                <input class="form-control" value="<?= $game->MinimumGPU ?>" id="MinimumGPU" name="MinimumGPU" placeholder="Minimum GPU"></input>
                <p class="hide text-danger" id='MinimumGPUError'>This field is required</p>
              </div> 

              <div class="mb-3">
                <input class="form-control" value="<?= $game->RecommendedGPU ?>" id="RecommendedGPU" name="RecommendedGPU" placeholder="Recommended GPU"></input>
                <p class="hide text-danger" id='RecommendedGPUError'>This field is required</p>
              </div>  

              <div class="mb-3">
                <input type="number" class="form-control" value="<?= $game->MinimumRam ?>" id="MinimumRam" name="MinimumRam" placeholder="Minimum Ram"></input>
                <p class="hide text-danger" id='saleError'>This field is required</p>
              </div>      
              
              <div class="mb-3">
                <input type="number" class="form-control" value="<?= $game->RecommendedRam ?>" id="RecommendedRam" name="RecommendedRam" placeholder="RecommendedRam"></input>
                <p class="hide text-danger" id='RecommendedRamError'>This field is required</p>
              </div>

              <div class="mb-3">
                <input type="number" value="<?= $game->Storage ?>" class="form-control" id="Storage" name="Storage" placeholder="Storage"></input>
