...
<body>
  ...
  <div class="container">
    ...
    <div class="row align-items-left container-form" id="formBox">
      <div class="col-lg-12">
          <form id="formBox" method="POST" action="../Controller/editReview.php" enctype="multipart/form-data">
            <div id="1">
              ...
              <div class="mb-3">
                <input type="Text" class="form-control" id="Text" name="Text"  value="<?= $review->Text ?>" placeholder="Text"></input>
